...
def parse_args():
    ...
    parser.add_argument('--PRR_n_img_x', type=int, default=1,
                        help='Number of images along x-axis')

    parser.add_argument('--PRR_n_img_y', type=int, default=1,
    ...
    parser.add_argument('--PMLR_n_img_x', type=int, default=1,
                        help='Number of images along x-axis')

    parser.add_argument('--PMLR_n_img_y', type=int, default=1,
                        help='Number of images along y-axis')
...
def main(args):
    ...
    """ prepare MNIST data """
    train_total_data, test_data = mnist_data.prepare_MNIST_data()
    n_samples = 3500
    """ build graph """
